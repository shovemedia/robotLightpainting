...
#define ARM_ROTATION_MAX        23		//	90
#define HAND_ROTATION_MIN       -36		//	-90
...
public:
	...
	void setServoSpeeds(unsigned char _servoSpeed); // 0=full speed, 1-255 slower to faster
